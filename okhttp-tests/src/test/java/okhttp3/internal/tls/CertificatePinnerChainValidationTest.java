...
public final class CertificatePinnerChainValidationTest {
    ...
    public void pinIntermediatePresentInChain() throws Exception {
        ...
        SslClient contextBuilder = new SslClient.Builder()
                ...
                .build();
        OkHttpClient client = defaultClient().newBuilder()
                                             .sslSocketFactory(contextBuilder.socketFactory,
    ...
    public void unrelatedPinnedLeafCertificateInChain() throws Exception {
        ...
        SslClient clientContextBuilder = new SslClient.Builder()
                ...
                .build();
        OkHttpClient client = defaultClient().newBuilder()
                                             .sslSocketFactory(clientContextBuilder.socketFactory,
                                                     clientContextBuilder.trustManager)
                                             .hostnameVerifier(new RecordingHostnameVerifier())
                                             .certificatePinner(certificatePinner)
                                             .build();
        ...
        SslClient serverSslContext = sslBuilder.certificateChain(
                rogueCertificate.keyPair, rogueCertificate.certificate, compromisedIntermediateCa.certificate,
                goodCertificate.certificate, rootCa.certificate)
                                               .build();
        server.useHttps(serverSslContext.socketFactory, false);
        server.enqueue(new MockResponse()
                .setBody("abc")
    ...
    public void unrelatedPinnedIntermediateCertificateInChain() throws Exception {
        ...
        SslClient serverSslContext = sslBuilder.certificateChain(
                rogueCertificate.keyPair, rogueCertificate.certificate, goodIntermediateCa.certificate,
                compromisedIntermediateCa.certificate, compromisedRootCa.certificate)
                                               .build();
        server.useHttps(serverSslContext.socketFactory, false);
        server.enqueue(new MockResponse()
                .setBody("abc")
